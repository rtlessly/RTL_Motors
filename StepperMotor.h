/******************************************************************
 4-Wire interface for a stepper motor connected to an Arduino. This
 interface requires 4 digital pins on the Arduino. It is assumed that
 the motor is connected to the Arduino via a simple pass-thru power
 controller such as an ULN2003 or ULN2004 Darlington array. 
